...
function loadActivities(page) {
    ...
    tbody.innerHTML = '<tr><td colspan="4"><div style="padding: 20px;"><div style="display: flex; align-items: center; gap: 12px; margin-bottom: 16px;"><div style="width: 38px; height: 38px; border-radius: 10px; background: var(--bg-secondary); animation: skeleton-pulse 1.5s ease-in-out infinite;"></div><div style="flex: 1;"><div style="height: 14px; width: 40%; background: var(--bg-secondary); border-radius: 4px; margin-bottom: 8px; animation: skeleton-pulse 1.5s ease-in-out infinite;"></div><div style="height: 12px; width: 25%; background: var(--bg-secondary); border-radius: 4px; animation: skeleton-pulse 1.5s ease-in-out infinite;"></div></div></div><div style="display: flex; align-items: center; gap: 12px; margin-bottom: 16px;"><div style="width: 38px; height: 38px; border-radius: 10px; background: var(--bg-secondary); animation: skeleton-pulse 1.5s ease-in-out infinite;"></div><div style="flex: 1;"><div style="height: 14px; width: 50%; background: var(--bg-secondary); border-radius: 4px; margin-bottom: 8px; animation: skeleton-pulse 1.5s ease-in-out infinite;"></div><div style="height: 12px; width: 35%; background: var(--bg-secondary); border-radius: 4px; animation: skeleton-pulse 1.5s ease-in-out infinite;"></div></div></div><div style="display: flex; align-items: center; gap: 12px;"><div style="width: 38px; height: 38px; border-radius: 10px; background: var(--bg-secondary); animation: skeleton-pulse 1.5s ease-in-out infinite;"></div><div style="flex: 1;"><div style="height: 14px; width: 45%; background: var(--bg-secondary); border-radius: 4px; margin-bottom: 8px; animation: skeleton-pulse 1.5s ease-in-out infinite;"></div><div style="height: 12px; width: 30%; background: var(--bg-secondary); border-radius: 4px; animation: skeleton-pulse 1.5s ease-in-out infinite;"></div></div></div></div></td></tr>';
