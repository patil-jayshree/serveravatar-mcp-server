...
<head>
    ...
    <title>Register - ServerAvatar MCP</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .checkbox-group { display: flex; align-items: flex-start; gap: 10px; cursor: pointer; margin-bottom: 1.5rem; }
        .checkbox-group input { width: 18px; height: 18px; margin-top: 2px; accent-color: var(--accent-primary); flex-shrink: 0; }
        .checkbox-group span { font-size: 0.85rem; color: var(--text-secondary); line-height: 1.5; }
        .checkbox-group a { color: var(--accent-primary); text-decoration: none; }
...
<body>
        ...
        <div class="auth-wrapper">
            <div class="auth-card">
                <div class="auth-brand">
                    ...
                    <p class="auth-subtitle">Get started with ServerAvatar MCP</p>
                </div>
                <form method="post" action="{{ route('register') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="email" name="email" class="form-input" value="{{ old('email', '') }}" placeholder="you@example.com" required>
                    </div>
                    <div class="form-group">
                        ...
                        <div style="position: relative;">
                            ...
                            <button type="button" onclick="toggleRegisterPassword()" style="position: absolute; right: 12px; top: 50%; transform: translateY(-50%); background: none; border: none; cursor: pointer; color: var(--text-muted); padding: 0; display: flex; align-items: center;">
                                <svg class="eye-icon-register" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                                    <circle cx="12" cy="12" r="3"></circle>
                                </svg>
                                <svg class="eye-off-icon-register" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="display: none;">
                    ...
                    <div class="form-group">
                        ...
                        <div style="position: relative;">
                            ...
                            <button type="button" onclick="toggleRegisterConfirmPassword()" style="position: absolute; right: 12px; top: 50%; transform: translateY(-50%); background: none; border: none; cursor: pointer; color: var(--text-muted); padding: 0; display: flex; align-items: center;">
                                <svg class="eye-icon-confirm" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                                    <circle cx="12" cy="12" r="3"></circle>
                                </svg>
                                <svg class="eye-off-icon-confirm" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="display: none;">
                                    <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"></path>
                                    <line x1="1" y1="1" x2="23" y2="23"></line>
                                </svg>
                            </button>
    ...
    <script>
        function toggleRegisterPassword() {
            ...
            var eyeIcon = document.querySelector('.eye-icon-register');
            var eyeOffIcon = document.querySelector('.eye-off-icon-register');
        ...
        function toggleRegisterConfirmPassword() {
            ...
            var eyeOffIcon = document.querySelector('.eye-off-icon-confirm');
            if (input.type === 'password') {
                input.type = 'text';
                eyeIcon.style.display = 'none';
                eyeOffIcon.style.display = 'block';
