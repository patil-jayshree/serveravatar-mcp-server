...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        [data-theme="dark"] .guide-modal-sidebar { background: #1e1e32; border-color: #2d2d44; }
        [data-theme="dark"] .guide-modal-step-num { background: #6d28d9; }
        [data-theme="dark"] .guide-modal-step-title { color: #f1f5f9; }
        [data-theme="dark"] .guide-modal-header-title { color: #f1f5f9; }
        [data-theme="dark"] .guide-modal-header-subtitle { color: #94a3b8; }
        [data-theme="dark"] .guide-modal-close-btn { color: #f1f5f9; }
        [data-theme="dark"] .guide-modal-need-help { background: rgba(139, 92, 246, 0.15); border-color: rgba(139, 92, 246, 0.3); }
        [data-theme="dark"] .guide-modal-need-help p { color: #c4b5fd; }
        [data-theme="dark"] .guide-modal-need-help a { color: #a78bfa; }
        [data-theme="dark"] .guide-modal-logo-wrap { background: rgba(255,255,255,0.1); }
        [data-theme="dark"] .guide-modal-step-text { color: #f1f5f9; }
        [data-theme="dark"] .guide-modal-step-text-active { color: #a78bfa; }
        [data-theme="dark"] .guide-modal-need-help-desc { color: #94a3b8; }
        [data-theme="dark"] .guide-modal-step-card { background: #1e1e32; border-color: #2d2d44; }
        [data-theme="dark"] .guide-modal-step-card h4 { color: #a78bfa; }
        [data-theme="dark"] .guide-modal-step-card h4 span { color: #f1f5f9; }
        [data-theme="dark"] .guide-modal-substep-text { color: #f1f5f9; }
        [data-theme="dark"] .guide-modal-info-note { background: rgba(139, 92, 246, 0.15); border-color: rgba(139, 92, 246, 0.3); }
        [data-theme="dark"] .guide-modal-info-note p { color: #c4b5fd; }
        [data-theme="dark"] .guide-modal-info-note .note-title { color: #c4b5fd; }
        [data-theme="dark"] .guide-modal-info-note .note-text { color: #94a3b8; }
        [data-theme="dark"] .guide-modal-note-box { background: rgba(139, 92, 246, 0.15); border-color: rgba(139, 92, 246, 0.3); }
        [data-theme="dark"] .guide-modal-note-box p { color: #c4b5fd; }
        [data-theme="dark"] .guide-modal-example-btn { background: rgba(139, 92, 246, 0.15); border-color: rgba(139, 92, 246, 0.3); color: #a78bfa; }
        [data-theme="dark"] .guide-modal-desc-text { color: #f1f5f9; }
        [data-theme="dark"] .guide-modal-vscode-info { background: rgba(139, 92, 246, 0.15); border-color: rgba(139, 92, 246, 0.3); }
        [data-theme="dark"] .guide-modal-vscode-info p { color: #c4b5fd; }
        [data-theme="dark"] .guide-modal-vscode-section-title h4 { color: #f1f5f9; }
        [data-theme="dark"] .guide-modal-vscode-section-title p { color: #94a3b8; }
        [data-theme="dark"] .guide-modal-oauth-card { background: rgba(16, 185, 129, 0.15); border-color: rgba(16, 185, 129, 0.3); }
        [data-theme="dark"] .guide-modal-oauth-icon { background: #059669; }
        [data-theme="dark"] .guide-modal-oauth-badge { background: rgba(16, 185, 129, 0.3); color: #6ee7b7; }
        [data-theme="dark"] .guide-modal-oauth-title { color: #28d4a4; }
        [data-theme="dark"] .guide-modal-oauth-arrow { color: #6ee7b7; }
        [data-theme="dark"] .guide-modal-oauth-body p { color: #a7f3d0; }
        [data-theme="dark"] .guide-modal-oauth-content { border-color: rgba(16, 185, 129, 0.3); }
        [data-theme="dark"] .guide-modal-token-card { background: rgba(245, 158, 11, 0.15); border-color: rgba(245, 158, 11, 0.3); }
        [data-theme="dark"] .guide-modal-token-icon { background: #d97706; }
        [data-theme="dark"] .guide-modal-token-badge { background: rgba(245, 158, 11, 0.3); color: #fcd34d; }
        [data-theme="dark"] .guide-modal-token-title { color: #fcd34d; }
        [data-theme="dark"] .guide-modal-token-arrow { color: #fcd34d; }
        [data-theme="dark"] .guide-modal-token-body p { color: #fde68a; }
        [data-theme="dark"] .guide-modal-idetoken-card { background: rgba(139, 92, 246, 0.15); border-color: rgba(139, 92, 246, 0.3); }
        [data-theme="dark"] .guide-modal-idetoken-icon { background: #6d28d9; }
        [data-theme="dark"] .guide-modal-idetoken-title { color: #a78bfa; }
        [data-theme="dark"] .guide-modal-idetoken-arrow { color: #a78bfa; }
        [data-theme="dark"] .guide-modal-idetoken-body p { color: #c4b5fd; }
        [data-theme="dark"] .guide-modal-idetoken-body i { color: #a78bfa; }
        [data-theme="dark"] .guide-modal-idetoken-content { border-color: rgba(139, 92, 246, 0.3); }
        [data-theme="dark"] .guide-modal-help-box { background: rgba(245, 158, 11, 0.15); border-color: rgba(245, 158, 11, 0.3); }
        [data-theme="dark"] .guide-modal-help-box .help-icon { background: #d97706; }
        [data-theme="dark"] .guide-modal-help-box p { color: #fcd34d; }
        [data-theme="dark"] .guide-modal-help-box .help-title { color: #fcd34d; }
        [data-theme="dark"] .guide-modal-success-box { background: rgba(16, 185, 129, 0.15); border-color: rgba(16, 185, 129, 0.3); }
        [data-theme="dark"] .guide-modal-success-box p { color: #21af57; }
        [data-theme="dark"] .guide-success-box { background: rgba(139, 92, 246, 0.15); border-color: rgba(139, 92, 246, 0.3); }
        [data-theme="dark"] .guide-success-box p { color: #21af57; }
        [data-theme="dark"] .guide-modal-code { background: rgba(139, 92, 246, 0.2); color: #a78bfa; }
        [data-theme="dark"] .guide-modal-code-inline { background: #374151; color: #e2e8f0; }
        [data-theme="dark"] .guide-modal-bold-text { color: #f1f5f9; }
        [data-theme="dark"] .guide-modal-check-item { color: #a7f3d0; }
        [data-theme="dark"] .guide-modal-check-item i { color: #6ee7b7; }
        [data-theme="dark"] .guide-modal-idetoken-check { color: #c4b5fd; }
        [data-theme="dark"] .guide-modal-idetoken-check i { color: #a78bfa; }
        [data-theme="dark"] .guide-modal-code-block { background: #0f0f1a; }
        [data-theme="dark"] .guide-modal-code-block pre { color: #e2e8f0; }
        [data-theme="dark"] .guide-modal-tip-box { background: rgba(245, 158, 11, 0.15); border-color: rgba(245, 158, 11, 0.3); }
        [data-theme="dark"] .guide-modal-tip-box p { color: #fcd34d; }
        [data-theme="dark"] .guide-modal-error-text { color: #fca5a5; }
        [data-theme="dark"] .guide-modal-error-box { background: rgba(220, 38, 38, 0.15); border-color: rgba(220, 38, 38, 0.3); }
        [data-theme="dark"] .guide-modal-step-title { color: #f1f5f9; }
        [data-theme="dark"] .guide-modal-step-title span { color: #a78bfa; }
