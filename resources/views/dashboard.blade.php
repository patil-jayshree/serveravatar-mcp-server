                        ...
                        <div class="client-row">
                            <div class="client-col client-col-icon">
                                ...
                                @elseif($client->client_name == "Cursor")
                                    <img src="/images/clients/cursor-light.png" class="icon-light" width="28" height="28" style="border-radius: 6px; object-fit: contain; display: none;" onerror="this.style.display='none';" /><img src="/images/clients/cursor-dark.png" class="icon-dark" width="28" height="28" style="border-radius: 6px; object-fit: contain;" onerror="this.style.display='none';this.nextElementSibling.style.display='flex';" />
                                    <span class="client-icon-fallback" style="display: none;">💚</span>
