...
{
    public static function getLogoHtml(string $clientName): string
    {
        $logos = self::getClientImages();
        ...
        return '<span style="width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; font-size: 14px; font-weight: 700; color: white; background: linear-gradient(135deg, #7c3aed 0%, #a78bfa 100%); border-radius: 4px;">' . $firstLetter . '</span>';
    }
    
    private static function getClientImages(): array
    {
        return [
