...
#[Description('Disable/stop HTTP to HTTPS redirection for an application.')]
class StopForceHttpsTool extends Tool
{
    ...
    public function handle(Request $request): Response
    {
        ...
        $result = $this->apiCall(
            "/organizations/$organizationId/servers/$serverId/applications/$applicationId/ssl/stop-force-https",
            $user
        );
