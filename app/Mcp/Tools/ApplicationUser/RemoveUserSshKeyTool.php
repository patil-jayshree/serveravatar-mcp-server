...
/**
 * Remove the SSH key for an application user.
 */
#[Description('Remove the SSH key for an application user. This deletes the SSH public key assigned to the user.')]
class RemoveUserSshKeyTool extends Tool
{
    ...
    public function handle(Request $request): Response
    {
        ...
        $endpoint = "/organizations/$organizationId/servers/$serverId/system-users/$systemUserId/ssh-key-remove";
