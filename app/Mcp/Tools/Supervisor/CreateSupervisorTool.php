...
/**
 * Create a new supervisor for an application.
 * 
 * @example createSupervisor(organizationId: "227", serverId: "5432", applicationId: "123", name: "EmailWorker", command: "php artisan queue:work", autostart: true, autorestart: true, numprocs: 2, user: "appuser", logfile: "worker.log", loglevel: "info")
 */
#[Description('Create a new supervisor (process manager) for an application. Configure queue workers or background tasks with options for autostart, autorestart, number of processes, log level, and more. Requires organization_id, server_id, application_id, name, command, autostart, autorestart, numprocs, user, logfile, and loglevel.')]
class CreateSupervisorTool extends Tool
{
    ...
    public function handle(Request $request): Response
    {
        ...
        $data = $this->apiCall("/organizations/$organizationId/servers/$serverId/applications/$applicationId/supervisors", $user, $body, 'POST');
