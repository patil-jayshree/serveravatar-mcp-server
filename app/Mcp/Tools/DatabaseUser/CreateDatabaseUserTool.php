...
#[Description('Create a new database user for a specific database. Requires organization_id, server_id, database_id, username, and password. Optional: connection_preference (localhost, everywhere, specific_ip_addresses) and hostname (array of IPv4 addresses for remote access).')]
class CreateDatabaseUserTool extends Tool
{
    ...
    public function handle(Request $request): Response
    {
        ...
        $result = $this->apiCall("/organizations/$organizationId/servers/$serverId/databases/$databaseId/database-users", $user, $data, 'POST');
