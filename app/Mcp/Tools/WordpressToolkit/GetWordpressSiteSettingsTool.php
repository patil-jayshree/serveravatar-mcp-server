 ...
 */
#[Description('Get WordPress general settings including language, timezone, date/time formats, permalink structure, search engine visibility, and memory limits. Requires WordPress Toolkit add-on.')]
class GetWordpressSiteSettingsTool extends Tool
{
